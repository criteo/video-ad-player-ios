...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        // Set up programmatic navigation for iOS 12 and earlier
        if #available(iOS 13.0, *) {
            // SceneDelegate handles setup for iOS 13+
        } else {
            // Programmatic setup for iOS 12 and earlier
            window = UIWindow(frame: UIScreen.main.bounds)

            let rootViewController = AdListViewController()
    ...
    func application(
        ...
        // Remove storyboard reference for programmatic setup
        return config
    }
